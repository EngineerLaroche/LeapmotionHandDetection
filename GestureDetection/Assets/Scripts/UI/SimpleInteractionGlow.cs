...
public class SimpleInteractionGlow : MonoBehaviour
{
    ...
    private bool canPlayPressSound = true;
    ...
    void Update()
    {
        if (_material != null)
        {
            ...
            if (_intObj.isPrimaryHovered && usePrimaryHover)
            {
                ...
                {
                    SoundController.GetInstance().PlaySound(AudioE.hover);
            ...
            if (_intObj is InteractionButton && (_intObj as InteractionButton).isPressed)
            {
                ...
                if (canPlayPressSound)
                {
                    SoundController.GetInstance().PlaySound(AudioE.press);
                    canPlayPressSound = false;
                }
            }
            else { canPlayPressSound = true; }
