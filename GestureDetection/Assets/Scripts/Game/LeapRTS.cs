...
namespace Leap.Unity
{
    ...
    public class LeapRTS : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //Transform objectToManipulate = SelectionController.GetInstance().GetSelectedObject();
            //if (objectToManipulate != null && !PalmUIController.GetInstance().GetIsControlManipulation())
            //{
