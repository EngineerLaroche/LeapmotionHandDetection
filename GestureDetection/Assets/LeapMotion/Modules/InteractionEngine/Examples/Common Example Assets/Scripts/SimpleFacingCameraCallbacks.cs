...
{
    private static SimpleFacingCameraCallbacks instance = null;
    ...
    void Update()
    {
        if (toFaceCamera != null && !_initialized) initialize();
        ...
        if (GetIsFacingCamera(toFaceCamera, Camera.main, _isFacingCamera ? 0.77F : 0.82F) != _isFacingCamera)
        {
            ...
            if (_isFacingCamera) OnBeginFacingCamera.Invoke();
            else OnEndFacingCamera.Invoke();
        }
    }
    ...
    * SET BEGIN FACING
    *
    * INFO:    Demarre l'evenement qui affiche le Palm UI.
    *
    *****************************************************/
    public void SetBeginFacing()
    {
    ...
    * SET END FACING
    *
    * INFO:    Demarre l'evenement qui cache le Palm UI.
    *
    *****************************************************/
    public void SetEndFacing()
    {
    ...
    *
    *****************************************************/
    public static SimpleFacingCameraCallbacks GetInstance()
    {
        return instance;
    }
}
